...
DB_HOST="terraform-20250408021009975300000001.c85nzzgxods0.us-east-1.rds.amazonaws.com" #os.getenv("DB_HOST") testar isso amanha.
DB_PORT="5432" # pegar os exemplos que estao no do oliveira e comparar, salvar arquivo como backup.
DB_NAME="taxilookupdb" # passar os arquivos no spark-submit
DB_USER="foo"
...
spark = SparkSession.builder.appName("S3ParquetReader") \
            .config(
                "spark.jars.packages",
