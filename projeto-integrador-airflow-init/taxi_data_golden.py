...
S3_SCRIPT_KEY = "scripts/taxi_data_golden.py"  # Path to store the script
LOCAL_SCRIPT_PATH = "/opt/airflow/dags/script_gold.py"  # Local path on EC2

# EMR Cluster configuration
JOB_FLOW_OVERRIDES = {
    "Name": "Taxi Data Golden Cluster",
    ...
    "Tags": [
        ...
        {"Key": "Project", "Value": "TaxiDataGolden"}
    ]
}
...
SPARK_STEP = [
    {
        ...
        "HadoopJarStep": {
            ...
            "Args": [
                "spark-submit", #SPARK SUBMIT, PASSAR O PARAMETRO AQUI
                "--deploy-mode", "cluster",
                "--master", "yarn",
...
with DAG(
    ...
    description='Process taxi data using EMR Gold Layer',
    ...
    run_glue_crawler = GlueCrawlerOperator(
        ...
        config={
            "Name": "crawler_taxi_dados"
        },
        aws_conn_id="aws_default",
        wait_for_completion=True,  # Optional: waits for crawler to finish
        poll_interval=10           # Check every 10 seconds
    )

    # Set up the task dependencies
    upload_script >> create_emr_cluster >> add_step >> watch_step >> terminate_emr_cluster >> run_glue_crawler